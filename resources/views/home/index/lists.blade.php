	...
	<div class="content">
		<div class="container">
			<div class="  col-m-on">
				...
				<div class="in-line">
					...
					@for($vo=1;$vo<19;$vo++)
						...
						<div class="col-md-4 you-men <if condition='$vo%3 eq 0' >para-grid</if>">
							<a href="{{ url('/index/single') }}"><img class="img-responsive pic-in" src="/images/men.jpg" alt=" " ></a>
							<div class=" you-onto">
			...
			@for($vo=1;$vo<9;$vo++)
				...
				<li>
					<a href="#"><img class="img-responsive women" src="/images/faa.jpg" alt=""></a>
					<div class="hide-in">
						<p>Premium Denim Women's Hidden</p>
